...
public class Transfer2Part {
	...
	@Inject
	@Preference(nodePath="kr.co.d2net.netbro.transfer", value = "usetf2")
	String useYn;
	...
	@Inject @Optional
	public void  getUseEvent(@UIEventTopic(TransferEventConstants.TOPIC_USE_2) final String isUse) {
	...
	@Inject @Optional
	public void  getEvent(@UIEventTopic(TransferEventConstants.TOPIC_TRANSFER_2) final Transfer transfer) {
		if(logger.isDebugEnabled()) {
			logger.debug("2_part_num: "+transfer.getDeviceNum()+", ctNm: "+transfer.getCtNm());
		}
		...
		eventMap.put("TRANSFER_2", transfer);
		if(eventBroker != null)
