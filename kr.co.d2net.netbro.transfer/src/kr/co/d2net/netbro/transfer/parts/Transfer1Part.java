...
public class Transfer1Part {
	...
	@Inject
	@Preference(nodePath="kr.co.d2net.netbro.transfer", value = "usetf1") 
	String useYn;
	...
	@Inject @Optional
	public void  getUseEvent(@UIEventTopic(TransferEventConstants.TOPIC_USE_1) final String isUse) {
	...
	@Inject @Optional
	public void  getEvent(@UIEventTopic(TransferEventConstants.TOPIC_TRANSFER_1) final Transfer transfer) {
		if(logger.isDebugEnabled()) {
			logger.debug("1_part_num: "+transfer.getDeviceNum()+", ctNm: "+transfer.getCtNm());
		}
		...
		eventMap.put("TRANSFER_1", transfer);
		if(eventBroker != null) {
