...
public class Transfer3Part {
	...
	@Inject
	@Preference(nodePath="kr.co.d2net.netbro.transfer", value = "usetf3")
	String useYn;
	...
	@Inject @Optional
	public void  getUseEvent(@UIEventTopic(TransferEventConstants.TOPIC_USE_3) final String isUse) {
	...
	@Inject @Optional
	public void  getEvent(@UIEventTopic(TransferEventConstants.TOPIC_TRANSFER_3) final Transfer transfer) {
		if(logger.isDebugEnabled()) {
			logger.debug("3_part_num: "+transfer.getDeviceNum()+", ctNm: "+transfer.getCtNm());
		}
		...
		eventMap.put("TRANSFER_3", transfer);
		if(eventBroker != null)
